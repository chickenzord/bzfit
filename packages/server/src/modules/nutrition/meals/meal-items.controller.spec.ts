    ...
    items: [
      {
        ...
        serving: { id: 'serving-1', name: 'Cup', size: 100, unit: 'g', calories: 200, protein: 4, carbs: 44, fat: 0.4, status: 'VERIFIED' as const },
      ...
      },
      {
        ...
        serving: { id: 'serving-2', name: 'Piece', size: 120, unit: 'g', calories: 165, protein: 31, carbs: 0, fat: 3.6, status: 'VERIFIED' as const },
