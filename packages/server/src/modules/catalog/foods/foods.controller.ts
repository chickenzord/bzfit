...
export class FoodsController {
  ...
  @ApiResponse({ status: HttpStatus.CREATED, description: 'The food has been successfully created.' })
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'The food has been successfully updated.' })
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'Paginated list of foods' })
  async findAll(
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'List of matching foods' })
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'List of foods with NEEDS_REVIEW servings' })
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'Food details with servings' })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Food not found' })
